...
public class editorDeTexto extends javax.swing.JInternalFrame {

    StyledDocument estilos;
    Style estilo;
    ...
    public editorDeTexto() {
        ...
        estilos = tp_texto.getStyledDocument();
    ...
    private void color_letraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_color_letraMouseClicked
        try {
            ...
            estilos.setCharacterAttributes(tp_texto.getSelectionStart(),
    ...
    private void guardararch_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_guardararch_btnMouseClicked
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                Documento d = new Documento(tp_texto, estilos, estilo);
                bw.writeObject(d);
                bw.flush();
